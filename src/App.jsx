...
const navItems = [
  ...
  { label: "Prednosti", href: "#features" },
  { label: "Naši radovi", href: "#portfolio" },
  { label: "Partneri uspjeha", href: "#partners" },
  { label: "Kontakt", href: "#contact" },
];

const stats = [
  { value: "+100", label: "ciljanih svjetskih jezika" },
  { value: "24/7", label: "stalna globalna dostupnost" },
  { value: "114", label: "potpunih sura" },
  { value: "HQ", label: "vrhunski zvuk i slika" },
];

const heroCards = [
  { value: "114", label: "potpunih sura" },
  { value: "30", label: "džuzeva Kur'ana" },
  { value: "Precizno", label: "audio-vizuelno iskustvo" },
];

const heroBadges = [
  { icon: Sparkles, title: "Svjetlo i ljepota Kur'ana" },
  { icon: Globe, title: "Poruka svijetu" },
];
...
const identityCards = [
  {
    icon: Users,
    title: "Ko smo mi",
    text: "Sana je vakufski projekat čiji je cilj prenos značenja Kur'ana cijelom svijetu kroz audio i video kanale koji spajaju melodično učenje i precizan prijevod, kako bismo ponudili cjelovito duhovno iskustvo koje približava Allahovu riječ srcima ljudi na različitim jezicima svijeta.",
  },
  {
    icon: Eye,
    title: "Vizija",
    text: "Da budemo vodeća globalna platforma u prenošenju značenja Kur'ana svakom čovjeku na njegovom jeziku, savremenim pristupom koji spaja ljepotu, preciznost i modernu tehnologiju.",
  },
  {
    icon: Target,
    title: "Misija",
    text: "Pružiti prevedeni kur'anski audio i video sadržaj koji omogućava jasno i jednostavno razumijevanje značenja Kur'ana te doprinosi širenju upute i upoznavanju svijeta s Allahovom riječju na snažan i privlačan način.",
  },
];
...
const features = [
  {
    icon: Languages,
    title: "Prijevodi na više jezika",
    desc: "Prenos značenja Kur'ana narodima na njihovim jezicima jasnim i preciznim stilom koji poštuje smisao i poruku.",
  },
  {
    icon: Headphones,
    title: "Potpuno audio-vizuelno iskustvo",
    desc: "Kanali koji spajaju dirljivo učenje i prevedeni tekst u smirenom iskustvu dostojnom veličine Kur'ana.",
  },
  {
    icon: Globe,
    title: "Neprekidna globalna prisutnost",
    desc: "Digitalna i satelitska prisutnost koja otvara vrata dosega različitim kontinentima i platformama tokom cijelog dana.",
  },
  {
    icon: HeartHandshake,
    title: "Vakuf radi Allaha",
    desc: "Globalna da'vetska poruka u čijoj nagradi učestvuje svako ko doprinese širenju, podršci ili koristi od nje.",
  },
];
...
const channels = [
  {
    icon: Radio,
    title: "Satelitski i radijski kanali",
    desc: "Širenje značenja Kur'ana kroz audio i video kanale koji dopiru do različitih naroda na njihovim jezicima.",
  },
  {
    icon: MonitorPlay,
    title: "Društvene mreže i web stranice",
    desc: "Obnovljeno digitalno prisustvo koje olakšava pristup kur'anskom sadržaju i njegovo široko širenje.",
  },
  {
    icon: Layers3,
    title: "Aplikacije i raznovrsni digitalni mediji",
    desc: "Moderno i raznovrsno iskustvo praćenja kur'anskog sadržaja na način prilagođen različitim uređajima i platformama.",
  },
];
...
const partners = [
  {
    icon: ShieldCheck,
    title: "Šerijatske i islamske ustanove",
    desc: "Koje su doprinijele pružanju vjerodostojnih prijevoda značenja Kur'ana, uz osiguranje preciznosti i šerijatske utemeljenosti.",
  },
  {
    icon: Mic2,
    title: "Istaknuti učači milozvučnih glasova",
    desc: "Koji su obogatili projekat skrušenim i dirljivim učenjem koje na voljen i privlačan način stiže do srca.",
  },
  {
    icon: Headphones,
    title: "Kompanije za audio i tehničku produkciju",
    desc: "Koje su obezbijedile visokokvalitetna snimanja i profesionalnu audio-vizuelnu obradu.",
  },
  {
    icon: Users,
    title: "Producenti i volonteri",
    desc: "Koji su doprinijeli razvoju i širenju sadržaja kako bi stigao do što šire publike širom svijeta.",
  },
];
...
const impactCards = [
  {
    ...
    desc: "Poruka Kur'ana stigla je u domove širom svijeta, na više jezika koji se obraćaju ljudima na njihovom maternjem jeziku.",
  },
  {
    icon: Languages,
    title: "Pouzdani prijevodi",
    desc: "Obezbijeđeni su precizni prijevodi značenja Kur'ana pod nadzorom pouzdanih stručnih institucija radi očuvanja ispravnosti značenja.",
  },
  {
    icon: Headphones,
    title: "Potpuno iskustvo",
    desc: "Sadržaj koji spaja skrušeno učenje i vizuelni prijevod kako bi pružio snažno i lako razumljivo duhovno iskustvo.",
  },
  {
    icon: Send,
    title: "Dugotrajna poruka",
    desc: "Projekat doprinosi širenju upute i upoznavanju svijeta s Allahovom riječju savremenim stilom koji dopire do različitih grupa.",
  },
];
    ...
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[#0a1730]/60 p-3 sm:p-4">
      ...
      <div className="mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-white/10 bg-black/10 px-2 py-3 sm:h-18">
        {bars.map((height, index) => (
          <motion.div
            ...
            className="flex-1 self-end rounded-full bg-gradient-to-t from-blue-400 via-yellow-200 to-blue-200 opacity-95"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative h-2 w-full flex-1 overflow-visible rounded-full bg-white/10">
          <div
            className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-blue-300 via-yellow-200 to-blue-500"
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-blue-300/10">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[#08142b]/55 px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[#08142b]/55 px-4 py-4 text-white/80 ${
            large
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-[#08142b]/55 p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(37,99,235,0.20),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(247,215,116,0.16),transparent_22%),radial-gradient(circle_at_20%_80%,rgba(96,165,250,0.14),transparent_24%),linear-gradient(180deg,#030B18_0%,#071A38_42%,#0C2550_100%)]" />

        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-blue-400/16 blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              ...
              >
                <span className="block bg-gradient-to-r from-[#F7D774] via-blue-100 to-yellow-100 bg-clip-text text-transparent">
                  Sana Kur'anski Kanali
                </span>
              </motion.h1>
              ...
              >
                Audio i video kanali za prijevod značenja Kur'ana na sve svjetske jezike — vakuf radi Allaha Uzvišenog.
              </motion.p>
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    borderColor: "rgba(247,215,116,0.18)",
                    color: ACCENT,
                  }}
                >
                  <Sparkles
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-[#091730]/75 p-4 sm:mt-8 sm:p-6">
                      ...
                      <div className="space-y-3">
                        {[65, 88, 42].map((w, idx) => (
                          <motion.div
                            ...
                            className="h-3 rounded-full bg-gradient-to-r from-blue-200 via-yellow-100 to-blue-400"
                          />
                        ))}
                      </div>
                    )}
          ...
          <section id="about" className="py-4 lg:py-8">
            ...
            >
              <LargeSectionBadge icon={BookOpen} text="Globalni kur'anski identitet" />
            </motion.div>
          ...
          <section className="py-8 lg:py-12">
            <div className="mb-6 text-center">
              <LargeSectionBadge icon={Building2} text="Implementacija i nadzor" />
            </div>
            ...
            >
              {!isMobile && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(59,130,246,0.12),transparent_28%),radial-gradient(circle_at_80%_80%,rgba(247,215,116,0.10),transparent_32%)]" />
              )}

              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#08142b]/45 p-4 sm:p-6">
                  ...
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#08142b]/70 p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-blue-200/20 bg-blue-400/10 px-5 py-3 text-sm text-blue-100 transition hover:bg-blue-400/20 sm:text-base"
                      >
                        Posjetite Jasco
          ...
          <section id="features" className="py-12 lg:py-20">
            ...
            >
              {sectionBadge(Sparkles, "Prednosti platforme")}
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Kur'anska platforma koja koristi savremena sredstva da prenese značenja Kur'ana svijetu, pristupom koji spaja šerijatsku utemeljenost i modernu tehnologiju.
              </p>
            </motion.div>
          ...
          <section className="py-10 lg:py-14">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Send, "Kanali objave i dosega")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Višestruki kanali prisutnosti</h2>
            </motion.div>
          ...
          <section id="portfolio" className="py-12 lg:py-20">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Crown, "Naši radovi")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Primjeri naših radova</h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Mirisna kur'anska učenja i prijevodi značenja kur'anskih ajeta na različite jezike svijeta — Sana... poruka svjetovima.
              </p>
            </motion.div>
          ...
          <section className="py-12 lg:py-16">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Globe, "Uticaj projekta")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">
                Uticaj projekta i njegovo širenje širom svijeta
              </h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Globalna kur'anska poruka koja je ponudila pouzdane prijevode, snažno iskustvo i doprinijela dolasku značenja Kur'ana u domove širom svijeta.
              </p>
            </motion.div>
          ...
          <section id="partners" className="py-12 lg:py-20">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Users, "Partneri uspjeha")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Uspjeh izgrađen saradnjom</h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Projekat je ostvario uspjeh zahvaljujući saradnji s nizom istaknutih partnera, među kojima su stručne, medijske, produkcijske i volonterske grupe.
              </p>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="mx-auto mt-5 max-w-4xl text-base leading-8 text-white/75 sm:text-lg">
                  Sana je globalna da'vetska poruka i radujemo se vašim upitima, prijedlozima i partnerskim ponudama u bilo kojem trenutku, na jasan i neposredan način.
                </p>
              </div>
              ...
              >
                <div className="rounded-[2rem] border border-white/10 bg-[#08142b]/70 p-4 sm:p-6">
          ...
          <footer className="pb-8 pt-4 sm:pb-10">
            <div className={`rounded-[2rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10 ${glass}`}>
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                <div
                  className={`rounded-[1.8rem] border border-white/10 p-4 text-center sm:p-6 bg-[linear-gradient(135deg,rgba(8,28,59,0.96)_0%,rgba(14,44,92,0.93)_48%,rgba(28,71,138,0.90)_100%)] flex h-full flex-col items-center justify-center`}
                >
                ...
                <div className={`rounded-[1.6rem] border border-white/10 ${OUTER_GRADIENT} p-4 sm:p-5 flex flex-col items-center justify-center text-center`}>
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/10 bg-[#08142b]/50 px-4 py-3 text-sm transition hover:bg-white/10 sm:text-base"
                    >
                      <Mail className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      snachannel159@gmail.com
                    </a>

                    <div className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#08142b]/50 px-4 py-3 text-sm sm:text-base">
                      <MapPin className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      Amman - Jordan
                    </div>
                  </div>

                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/10 bg-[#08142b]/45 p-4">
                    <a
                    ...
                    <p className="mt-4 text-center text-sm leading-6 text-white/70">
                      Započnite svoje kur'ansko putovanje sada
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full rounded-[1.4rem] border border-white/10 bg-[#08142b]/45 p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-blue-300/10 text-white">
                            <GooglePlayIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[#0b1d3e]/60 p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-blue-200/20 bg-blue-400/10 py-3 text-sm font-bold text-blue-100 transition hover:scale-[1.01] hover:bg-blue-400/20"
                      >
              ...
              <div className="mt-8 border-t border-white/10 pt-5 text-center text-xs text-white/55 sm:text-sm">
                Sva prava zadržana © Sana Kur'anski Kanali.
              </div>
            </div>
          </footer>
        </div>
