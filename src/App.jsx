...
const softCard = `rounded-[2rem] border border-white/10 ${CARD_GRADIENT} md:backdrop-blur-xl backdrop-blur-sm shadow-[0_8px_22px_rgba(0,0,0,0.14)]`;
const gradientOuterCard = `rounded-[2rem] border border-white/10 ${CARD_GRADIENT} md:backdrop-blur-xl backdrop-blur-sm shadow-[0_8px_22px_rgba(0,0,0,0.14)]`;
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-4">
        ...
        <div className={`mt-4 rounded-2xl border border-white/10 ${CARD_INNER_GRADIENT} px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8`}>
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 ${CARD_INNER_GRADIENT} px-4 py-4 text-white/80 ${
            large
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      ...
      <div className={`mt-4 rounded-[1.3rem] border border-white/10 ${CARD_INNER_GRADIENT} p-3 sm:p-4`}>
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
                ...
                <div className="grid gap-2">
                  {navItems.map((item) => (
                    <a
                      ...
                      className={`rounded-2xl border border-white/10 ${CARD_INNER_GRADIENT} px-4 py-3 text-sm text-white/85 sm:text-base`}
                    >
                      {item.label}
                    </a>
                  ))}
              ...
              >
                {stats.map((item, i) => (
                  <motion.div
                    ...
                    className={`rounded-3xl border border-white/10 ${CARD_GRADIENT} p-3 text-center backdrop-blur-md shadow-[0_6px_16px_rgba(0,0,0,0.12)] sm:p-4`}
                  >
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className={`mt-6 rounded-[1.4rem] border border-white/10 ${CARD_INNER_GRADIENT} p-4 sm:mt-8 sm:p-6`}>
                    <div className="mb-4 flex items-start gap-3 text-sm text-white/80 sm:items-center sm:text-base">
                      <Headphones className="mt-0.5 h-5 w-5 shrink-0 text-white/80 sm:mt-0" />
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-2 text-center sm:mt-8 sm:gap-3">
                      {heroCards.map((item) => (
                        <div
                          key={item.label}
                          className={`rounded-2xl border border-white/10 ${CARD_INNER_GRADIENT} p-3 sm:p-4`}
                        >
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                <div className={`rounded-[1.8rem] border border-white/10 ${CARD_GRADIENT} p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center`}>
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    ...
                    <div className={`flex items-center justify-center gap-3 rounded-2xl border border-white/10 ${CARD_INNER_GRADIENT} px-4 py-3 text-sm sm:text-base`}>
                ...
                <div className={`rounded-[1.8rem] border border-white/10 ${CARD_GRADIENT} p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center`}>
                  ...
                  <div className={`w-full rounded-[1.4rem] border border-white/10 ${CARD_INNER_GRADIENT} p-4`}>
                    ...
                    <div className={`mt-5 rounded-[1.4rem] border border-white/10 ${CARD_INNER_GRADIENT} p-4`}>
